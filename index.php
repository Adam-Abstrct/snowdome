...
<body>
	...
	<header>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-4 col-md-3">
					<div class="green"> Annual Green Energy Generation <span id="green"></span></div>
				</div>
			</div>
		</div>
	</header>
	...
	<footer>
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-14 col-md-12 col-md-offset-1 footer__cont">
					<div class="col-sm-10">
						<div class="tips">
							<div class="tips__title">
								<p><i class="fa fa-info-circle tips__icon" aria-hidden="true"></i> Solar Energy Facts -</p>
							</div>
